...
async function main() {
  ...
  const jsFiles = ['app.js', 'store.js', 'charts.js', 'share.js', 'sentences.js', 'words.js', 'iconset.js', 'workspace.js'];
  try {
  ...
  // ---- 4. 复制静态资源（不压缩）----
  const staticFiles = ['favicon.svg', 'app-icon.svg', 'og-image.png', 'robots.txt', 'sitemap.xml', 'qrcode.min.js', '_worker.js', 'sw.js', 'manifest.webmanifest', '_headers'];
