...
async function main() {
  ...
  const jsFiles = ['app.js', 'store.js', 'charts.js', 'share.js', 'sentences.js', 'words.js', 'md5.js'];
  try {
  ...
  // ---- 4. 复制静态资源（不压缩）----
  const staticFiles = ['favicon.svg', 'og-image.png', 'robots.txt', 'sitemap.xml', 'qrcode.min.js', '_worker.js'];
